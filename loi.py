# 1 Decided NLP library(s)


# 2 Define Regex


# 3 Class and functions to handle storage


# 4 Main iteration process
...
#     with open("TextCorpus/grand_diary.txt") as wiki_line:
#         for x in wiki_line:
...
#     process_pool.map(myread,range(0,1))
#     mylisty=list(range(0,1))
#     while len(mylisty) >=1:
...
with open("TextCorpus/grand_diary.txt") as grandjournal:
